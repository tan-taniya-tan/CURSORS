    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["user_type"]."</td><td><a href='student_edit.php?email=".$row["email"]."'>Edit</a> | <a href='student_delete.php?email=".$row["email"]."'>Delete</a></td></tr>";
