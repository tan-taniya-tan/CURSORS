...
$add_record_query = "INSERT INTO `flashmob1`(`name`, `age`, `gender`,`rollno`,`class`,`section`, `event`) VALUES ('$name', '$age', '$gender','$rollno', '$class','$section','$event')";
...
<body>
    <center>
    <h1>Successfully Registered for Flashmob Event</h1>
